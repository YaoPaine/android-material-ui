...
import com.yaopaine.coordinatorylayout.BasicApp;
import com.yaopaine.coordinatorylayout.BuildConfig;
...
public class UcNewsContentBehavior extends HeaderScrollingViewBehavior {
    ...
    private int getHeaderOffsetRange() {
        return BasicApp.getAppContext().getResources().getDimensionPixelOffset(R.dimen.uc_news_header_pager_offset);
    }

    private int getFinalHeight() {
        return BasicApp.getAppContext().getResources().getDimensionPixelOffset(R.dimen.uc_news_tabs_height) + BasicApp.getAppContext().getResources().getDimensionPixelOffset(R.dimen.uc_news_header_title_height);
    }
